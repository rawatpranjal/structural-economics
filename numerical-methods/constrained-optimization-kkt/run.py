...
"""
    ...
    report.add_solution_method(
        ...
        "Dropping a constraint that binds means dropping a piece of complementary slackness, so a wrong-sign answer becomes possible. "
        ...
        "At each iterate it linearises the constraints and forms a small quadratic-programming subproblem with a BFGS Hessian approximation of the Lagrangian. "
        "Solving that subproblem gives a search direction. "
