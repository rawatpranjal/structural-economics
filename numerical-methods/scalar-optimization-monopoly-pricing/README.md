...
A monopolist with constant marginal cost faces a constant-elasticity demand. Pricing is one-dimensional. The profit-maximizing price has a closed form. That closed form, together with the Lerner markup, pins down what every numerical method should agree on.
