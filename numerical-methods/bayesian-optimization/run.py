...
def main() -> None:
    ...
    report.add_overview(
        ...
        "It places a probabilistic prior on the unknown objective, updates that prior to a posterior conditional on the evaluations collected so far, and chooses the next evaluation to maximize an acquisition function that trades off exploration of uncertain regions against exploitation of high-mean regions. "
