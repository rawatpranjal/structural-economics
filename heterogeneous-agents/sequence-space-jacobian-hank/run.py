...
def main() -> None:
    ...
    save_figure(fig1, "figures/irf-comparison.png", dpi=150)
    save_figure(fig2, "figures/quintile-irf.png", dpi=150)
    save_figure(fig3, "figures/anticipation-curves.png", dpi=150)
    save_figure(fig4, "figures/steady-state.png", dpi=150)
    ...
    save_thumbnail("figures/irf-comparison.png", "figures/thumb.png")
    elapsed = time.time() - t_start
    print(f"Figures and tables written in {elapsed:.1f} s")
