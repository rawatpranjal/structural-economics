...
"""
    ...
    report.add_figure(
        ...
        fig1,
        description=(
            "A 100 basis-point monetary tightening (matching the canonical "
            "Auclert et al. notebook) pushes the real rate up in both "
            "economies. Output and consumption fall on impact in HANK with "
            "a slightly smaller magnitude than in the representative-agent "
