...
**Step 2 -- IV/2SLS.** Price is endogenous (correlated with $\xi_j$). We instrument using cost shifters and BLP-style instruments (sum of rival characteristics). The first stage projects price onto the instrument space; the first-stage F-statistic is **1039.4** (well above the Stock-Yogo threshold of 10).
...
|:------------|-------:|-------:|----------:|----------:|
| alpha       |    1.5 |  1.427 |     1.5   |     0.013 |
| beta_sugar  |    0.3 |  0.961 |     1.041 |     0.024 |
| beta_fiber  |    0.5 |  1.212 |     1.317 |     0.028 |
| beta_const  |    1   | -6.005 |    -6.731 |     0.241 |
