...
def main() -> None:
    ...
    print("Simulating persistent shocks and multiplier-accelerator dynamics...")
    ...
    report.add_overview(
        ...
        "[RBC TFP-shock tutorial](../../dsge/rbc/), it drives technology. In the "
        "[New Keynesian tutorial](../../dsge/nkdsge/), the same idea is used for "
        ...
        "responds to changes in consumption."
    )
...
"""
    ...
    report.add_model_setup(
        ...
        "|---|---:|---|\n"
        f"| $\\rho$ | {rho_ar1:.2f} | Persistence of the state |\n"
        f"| $\\sigma$ | {sigma_ar1:.2f} | Innovation standard deviation |\n"
        ...
        f"| $\\rho_g$ | {rho_g:.2f} | Persistence of government spending deviations |\n"
    ...
    report.add_figure(
        ...
        fig2,
        description=(
            "The government spending process is monotone, but income need not simply "
    ...
    report.add_figure(
        ...
        description=(
            ...
            "not only unconditional volatility."
        ),
    )
    ...
    report.add_takeaway(
        "An AR(1) coefficient is an economic timing assumption. With "
        ...
        "the shock law from the propagation mechanism. Government spending supplies "
        "the persistent disturbance; lagged consumption and accelerator investment "
        "turn it into a richer income path."
    )
