...
| [<img src="global-dsge/deep-learning-optimal-growth/figures/thumb.png" width="160">](global-dsge/deep-learning-optimal-growth/figures/policy-comparison.png) | **[Deep Learning for Optimal Growth](global-dsge/deep-learning-optimal-growth/)** | Approximate the Brock-Mirman saving rule with a small JAX neural policy. Euler-residual training learns on simulated capital states, and the closed form audits the fit. |
...
| [<img src="industrial-organization/auction-valuation-recovery/figures/thumb.png" width="160">](industrial-organization/auction-valuation-recovery/figures/recovered-cdf.png) | **[Recovering Auction Values from First-Price Bids](industrial-organization/auction-valuation-recovery/)** | Use first-price auction equilibrium conditions to turn observed bids into pseudo-values. A simulated IPV benchmark shows where bid-density inversion recovers the latent value distribution and where trimming matters. |
...
| [<img src="computational-methods/q-learning-growth/figures/thumb.png" width="160">](computational-methods/q-learning-growth/figures/policy-comparison.png) | **[Stochastic Optimal Growth by Q-Learning](computational-methods/q-learning-growth/)** | Solve a Brock-Mirman growth MDP without a transition matrix. Tabular Q-learning learns the saving rule from sampled transitions, and the closed-form log-policy audits both Q-learning and value iteration. |
| [<img src="computational-methods/q-learning-bus-engine/figures/thumb.png" width="160">](computational-methods/q-learning-bus-engine/figures/replacement-hazard.png) | **[Bus Engine Replacement by Q-Learning](computational-methods/q-learning-bus-engine/)** | Recover Rust's replacement hazard without a transition matrix. Soft Q-learning on simulated mileage trajectories matches the NFXP value function, and a DQN appendix shows the same with function approximation. |
