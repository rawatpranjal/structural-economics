...
|---|---|---|
| [<img src="numerical-methods/root-finding/figures/thumb.png" width="160">](numerical-methods/root-finding/figures/excess-demand.png) | **[Scalar Root Finding for Equilibrium Rates](numerical-methods/root-finding/)** | Find the interest rate that clears a stylized bond market. Bisection, secant, Brent, and Newton-Raphson all recover it, but only the bracketed methods stay reliable from a poor starting guess. |
| [<img src="numerical-methods/scalar-optimization/figures/thumb.png" width="160">](numerical-methods/scalar-optimization/figures/golden-section-trace.png) | **[One-Dimensional Optimization for Bellman Inner Steps](numerical-methods/scalar-optimization/)** | Choose how much of a fixed cake to eat each period under log utility. Golden section search and Newton's method both find the optimal share; Newton is fast near the answer but unstable from far away. |
| [<img src="numerical-methods/interpolation/figures/thumb.png" width="160">](numerical-methods/interpolation/figures/target-vs-fit.png) | **[Off-Grid Function Approximation by Interpolation](numerical-methods/interpolation/)** | Read a value function off the grid points where it is stored. Linear, cubic spline, and shape-preserving PCHIP handle smooth and kinked targets differently, with PCHIP avoiding the spline's ringing at borrowing-constraint kinks. |
