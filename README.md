...
| [<img src="game-theory/cfr-asymmetric-auction/figures/thumb.png" width="160">](game-theory/cfr-asymmetric-auction/figures/bid-functions-asymmetric.png) | **[Asymmetric First-Price Auctions by Counterfactual Regret Minimization](game-theory/cfr-asymmetric-auction/)** | Two bidders with different value supports admit no closed-form BNE. Vanilla CFR and CFR+ run regret matching at each type, with exploitability as the convergence diagnostic. |
