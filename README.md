...
|---|---|---|
| [<img src="dynamic-programming/shock-discretization/figures/thumb.png" width="160">](dynamic-programming/shock-discretization/figures/stationary-mass.png) | **[Discretizing Persistent Shocks](dynamic-programming/shock-discretization/)** | Turn persistent income or productivity risk into the finite Markov chain used in Bellman expectations. Rouwenhorst preserves variance and persistence on a coarse grid; Tauchen is transparent but can distort continuation values when shocks are highly persistent. |
