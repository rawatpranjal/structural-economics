...
"""
    ...
    report.add_figure("figures/value-functions.png",
        ...
        description="At the equilibrium interest rate, higher-income agents enjoy uniformly greater lifetime utility. "
        "The steepness near the borrowing constraint reveals the shadow value of liquidity: an extra unit of assets is worth far more when the constraint is nearly binding.")
    ...
    report.add_figure("figures/savings-policy.png",
        ...
        description="Where the policy function lies above the 45-degree line the agent is accumulating assets; below it the agent is decumulating. "
        "Low-income agents draw down savings at most asset levels, while high-income agents save aggressively, driving the right skew of the wealth distribution.")
    ...
    report.add_figure("figures/wealth-distribution.png",
        ...
        description="The distribution is right-skewed with a mass point near the borrowing constraint, reflecting agents who have experienced "
        "strings of bad income shocks. The long right tail is generated by persistent high-income realizations that allow sustained accumulation.")
    ...
    report.add_figure("figures/capital-market.png",
        ...
        description="The equilibrium lies where the upward-sloping supply curve (household precautionary savings) meets the downward-sloping "
        "demand curve (firm's diminishing marginal product). The equilibrium r falls below 1/beta-1 because uninsurable risk pushes households to over-save.")
    ...
    report.add_table("tables/equilibrium.csv", "General Equilibrium Outcomes", df,
        description="The equilibrium outcomes summarize how incomplete markets distort aggregates relative to the complete-markets benchmark. "
        "The gap between r and 1/beta-1, the Gini coefficient, and the fraction at the constraint are the key diagnostics for this class of models.")
