...
| Asset grid | 100 points | Exponential spacing on $[0.0, 50.0]$ |
...
Equilibrium interest rate: $r^* = 0.026996$ (vs. $1/\beta - 1 = 0.041667$).
...
| Variable                   | Value               |
|:---------------------------|:--------------------|
| Interest rate $r$          | 0.026996            |
| Wage $w$                   | 1.2664              |
| Capital $K$                | 6.7651              |
| Output $Y$                 | 1.9902              |
| Capital-output ratio $K/Y$ | 3.3992              |
| Gini coefficient           | 0.4532              |
| Fraction at constraint     | 0.0411              |
| $r$ vs $1/\beta - 1$       | 0.026996 < 0.041667 |
...
**Key insights:**
- The equilibrium interest rate $r^* = 0.0270$ is below the rate of time preference $1/\beta - 1 = 0.0417$. This wedge arises because agents over-save as a buffer against income risk, pushing down the return on capital.
- The wealth Gini coefficient is 0.453, reflecting the right-skewed distribution generated by persistent income shocks and the borrowing constraint.
- About 4.1% of agents are at the borrowing constraint in the stationary distribution, indicating significant liquidity pressure.
