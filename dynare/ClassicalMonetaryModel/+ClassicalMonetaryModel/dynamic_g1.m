...
g1 = zeros(12, 23);
g1(1,6)=(-(T(2)*getPowerDeriv(y(6),params(3),1)));
g1(1,7)=1;
g1(1,10)=(-(T(1)*getPowerDeriv(y(10),params(5),1)));
...
g1(6,11)=1;
g1(6,12)=(-y(19));
g1(7,8)=(-(exp(y(14))*1/params(2)*getPowerDeriv(y(8),params(4),1)));
g1(7,12)=1;
g1(7,14)=(-T(7));
g1(8,6)=1;
g1(8,13)=(-1);
...
g1(12,6)=(-(4*1/y(6)));
g1(12,8)=(-(4*1/y(8)));
g1(12,3)=(-(4*(-(params(6)*(-(1/y(3)))))));
g1(12,11)=(-(4*(-(params(6)*1/y(11)))));
g1(12,15)=1;
