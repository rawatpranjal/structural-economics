...
- **See also.** The same Rust replacement model is estimated by NFXP, CCP, MPEC, and a maximum-causal-entropy IRL benchmark in [`industrial-organization/dynamic-discrete-choice/`](../../industrial-organization/dynamic-discrete-choice/). The four estimators recover the identical hazard the soft Q-learning here reproduces.
