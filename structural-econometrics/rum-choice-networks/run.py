...
def main() -> None:
    ...
    report.add_overview(
        ...
        "The tutorial keeps those two concerns separate. Prediction improves only if the model "
        "learns the nonlinear utility surface out of sample. Economic discipline comes from "
        "keeping probabilities tied to utility maximization over a choice set.\n\n"
