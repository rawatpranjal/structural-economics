...
def main() -> None:
    ...
    report.add_overview(
        ...
        "The filter keeps a distribution, not just a fitted line. Its mean is the nowcast "
        "and its covariance records how much uncertainty remains after the current signal.\n\n"
...
"""
    ...
    report.add_solution_method(
        ...
        "The prediction step asks what the state should look like before seeing the new "
        "signal. The update step asks how surprising the signal is relative to that "
        "prediction. A precise signal or an uncertain prior produces a larger gain; a "
        "noisy signal produces a smaller gain. The same forecast error also contributes "
        "the likelihood increment used for estimation.\n\n"
        "```text\n"
